...
with st.sidebar: st.markdown("## الأدوات") choice = st.radio("", [ "🏠 الرئيسية", "📊 Excel Master", "🧹 Power Query", "📈 Power BI", "🐍 Python Lab", "👁️ OCR Engine", "☁️ Google Sheets", "🖼️ Tableau", "🗄️ SQL Lab", "🤖 AI Brain (Core)" ])
